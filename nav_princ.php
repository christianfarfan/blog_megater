<nav class="navbar navbar-expand-sm bg-info navbar-dark">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="./iniciando_session.php"><span class="glyphicon glyphicon-user"></span><span style="color: black;font-size:20px">Iniciar sesión</span></a></li>
      <li><a href="./registro_usua.php"><span class="glyphicon glyphicon-log-in"></span><span style="color: black;font-size:20px">Registrarse</span></a></li>
    </ul>
  </div>
</nav>
